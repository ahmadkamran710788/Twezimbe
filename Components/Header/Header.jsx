        ...
        <div className="flex justify-between items-center sm:px-8">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <div className="flex gap-4">
              <button className="bg-transparent hover:bg-blue-500 text-[#1170B2] font-normal hover:text-white py-2 px-6 border border-blue-500 hover:border-transparent rounded">
                Sign In
              </button>
              <button className="bg-[#1170B2] hover:bg-blue-700 text-white font-bold py-2 px-4 border rounded">
                Create Free Account
              </button>
            </div>
          </div>
